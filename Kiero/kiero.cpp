...
static uintptr_kiero* g_methodsTable = NULL;
	...
	if (_renderType != RenderType::None)
	{
		if (_renderType >= RenderType::D3D9 && _renderType <= RenderType::D3D12)
		{
			...
			if (_renderType == RenderType::D3D9)
			{
				...
				g_methodsTable = (uintptr_kiero*)::calloc(119, sizeof(uintptr_kiero));
				::memcpy(g_methodsTable, *(uintptr_kiero**)device, 119 * sizeof(uintptr_kiero));
			...
			else if (_renderType == RenderType::D3D10)
			{
				...
				g_methodsTable = (uintptr_kiero*)::calloc(116, sizeof(uintptr_kiero));
				::memcpy(g_methodsTable, *(uintptr_kiero**)swapChain, 18 * sizeof(uintptr_kiero));
				::memcpy(g_methodsTable + 18, *(uintptr_kiero**)device, 98 * sizeof(uintptr_kiero));
			...
			else if (_renderType == RenderType::D3D11)
			{
				...
				g_methodsTable = (uintptr_kiero*)::calloc(205, sizeof(uintptr_kiero));
				::memcpy(g_methodsTable, *(uintptr_kiero**)swapChain, 18 * sizeof(uintptr_kiero));
				::memcpy(g_methodsTable + 18, *(uintptr_kiero**)device, 43 * sizeof(uintptr_kiero));
				::memcpy(g_methodsTable + 18 + 43, *(uintptr_kiero**)context, 144 * sizeof(uintptr_kiero));
			...
			else if (_renderType == RenderType::D3D12)
			{
				...
				g_methodsTable = (uintptr_kiero*)::calloc(150, sizeof(uintptr_kiero));
				::memcpy(g_methodsTable, *(uintptr_kiero**)device, 44 * sizeof(uintptr_kiero));
				::memcpy(g_methodsTable + 44, *(uintptr_kiero**)commandQueue, 19 * sizeof(uintptr_kiero));
				::memcpy(g_methodsTable + 44 + 19, *(uintptr_kiero**)commandAllocator, 9 * sizeof(uintptr_kiero));
				::memcpy(g_methodsTable + 44 + 19 + 9, *(uintptr_kiero**)commandList, 60 * sizeof(uintptr_kiero));
				::memcpy(g_methodsTable + 44 + 19 + 9 + 60, *(uintptr_kiero**)swapChain, 18 * sizeof(uintptr_kiero));
		...
		else if (_renderType != RenderType::Auto)
		{
			if (_renderType == RenderType::OpenGL)
			{
				...
				g_methodsTable = (uintptr_kiero*)::calloc(size, sizeof(uintptr_kiero));

				for (int i = 0; i < size; i++)
				{
					g_methodsTable[i] = (uintptr_kiero)::GetProcAddress(libOpenGL32, methodsNames[i]);
				}
			...
			else if (_renderType == RenderType::Vulkan)
			{
				...
				for (int i = 0; i < size; i++)
				{
					g_methodsTable[i] = (uintptr_kiero)::GetProcAddress(libVulkan, methodsNames[i]);
				}
...
uintptr_kiero* kiero::getMethodsTable()
{
