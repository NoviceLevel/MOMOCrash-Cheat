...
// UTF-8 string macro for C++20 compatibility (char8_t to const char*)
...
#include "Features/GameCheats/GameCheats.h" // Must be before other features - defines global instance pointers and hooks
